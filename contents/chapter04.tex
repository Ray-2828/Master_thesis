...
\section{Multi-resource system with OFDM}
\label{sec:ofdm}
...
We first evaluate the BLER performance of the synchronous coded OFDM NOMA system with different receivers discussed above. However, perfect synchronous transmission is impractical especially for uplink transmissions, where users may arrive at the base station with different timing offsets \cite{haci2017performance}. Therefore, we further study asynchronous uplink transmission and examines the robustness of these receivers under user-dependent timing offsets.

\subsection{OFDM System and channel Model}
...
\begin{comment}
\subsection{MMSE-SIC-IDD for OFDM}
